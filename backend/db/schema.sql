...
-- ---------------------------------------------------------
-- CANONICAL RECORDS + MULTI-DOCUMENT EVIDENCE
-- ---------------------------------------------------------
--
-- A home should have one roof, one furnace, one 2021
-- replacement project — not one record per uploaded PDF.
-- Duplicates are grouped with merged_into_id instead of
-- being deleted. Questionable matches are flagged.
