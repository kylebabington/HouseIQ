/**
 * Agent Run Inspector — persisted agent_runs for judges.
 * Shows the Ask pipeline or the Memory Auditor MCP tool trace.
 */
...
function AdviceHistoryPanel({
  ...
  const header = hideHeader ? null : <h4>Agent Run Inspector</h4>;

  if (isLoading) {
    return (
      <section className="advice-history agent-run-inspector">
        {header}
